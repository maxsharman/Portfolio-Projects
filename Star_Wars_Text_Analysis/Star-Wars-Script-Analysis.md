...
![](Star-Wars-Script-Analysis_files/figure-gfm/Word_Frequency.png)<!-- -->
...
![](Star-Wars-Script-Analysis_files/figure-gfm/Sentiments.png)<!-- -->

Extracting all the characters from the script. Here, I replace commas in the text to avoid having names separated.
